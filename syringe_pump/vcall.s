...
@_ZTV11UserAccount = linkonce_odr hidden unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI11UserAccount to i8*), i8* bitcast (%struct.UserAccount* (%struct.UserAccount*)* @_ZN11UserAccountD2Ev to i8*), i8* bitcast (void (%struct.UserAccount*)* @_ZN11UserAccountD0Ev to i8*)] }, comdat, align 4, !type !0, !type !1
...
@_ZTV7Account = linkonce_odr hidden unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8* }* @_ZTI7Account to i8*), i8* bitcast (%struct.Account* (%struct.Account*)* @_ZN7AccountD2Ev to i8*), i8* bitcast (void (%struct.Account*)* @_ZN7AccountD0Ev to i8*)] }, comdat, align 4, !type !1
@_ZTV12AdminAccount = linkonce_odr hidden unnamed_addr constant { [4 x i8*] } { [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI12AdminAccount to i8*), i8* bitcast (%struct.AdminAccount* (%struct.AdminAccount*)* @_ZN12AdminAccountD2Ev to i8*), i8* bitcast (void (%struct.AdminAccount*)* @_ZN12AdminAccountD0Ev to i8*)] }, comdat, align 4, !type !2, !type !1
...
define linkonce_odr hidden void @_ZN7Account8showNameEv(%struct.Account*) #8 comdat align 2 !type !6 {
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr hidden void @_ZN12AdminAccount10adminStuffEv(%struct.AdminAccount*) #8 comdat align 2 !type !6 {
...
; Function Attrs: noinline nounwind optnone
define linkonce_odr hidden void @_ZN11UserAccount10adminStuffEv(%struct.UserAccount*) #8 comdat align 2 !type !6 {
...
!1 = !{i64 8, !"_ZTS7Account"}
!2 = !{i64 8, !"_ZTS12AdminAccount"}
!3 = !{i32 1, !"wchar_size", i32 4}
!4 = !{i32 1, !"min_enum_size", i32 4}
!5 = !{!"clang version 7.0.1-8+rpi3+deb10u2 (tags/RELEASE_701/final)"}
!6 = !{i64 0, !"_ZTSM7AccountFvvE"}
